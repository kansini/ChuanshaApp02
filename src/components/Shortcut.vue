    ...
    #shortcut {
        ...
        .shortcut-item-01 {
            ...
            &::before {
                top: calc(-48rem / 96);
                left: calc(118rem / 96);
                width: calc(230rem / 96);
                height: calc(360rem / 96);
                transform: rotate(15deg);
            }

            &::after {
                top: calc(96rem / 96);
                right: calc(-190rem / 96);
                width: calc(270rem / 96);
                height: calc(364rem / 96);
                transform: rotate(15deg);
            }
        ...
        .shortcut-item-03 {
            ...
            &::after {
                top: calc(38rem / 96);
                left: calc(18rem / 96);
                width: calc(406rem / 96);
                height: calc(248rem / 96);
        ...
        .open {
            ...
            z-index: 999;
            animation: open linear .4s forwards;
